...
pages = {
  ...
  "Tools": [
    ...
    st.Page("tools_pages/therapist.py", title="Support", icon="❤️"),
    st.Page("tools_pages/recommendations.py", title="Recommendations", icon="💡"), 
    st.Page("tools_pages/moderators.py", title="Moderators", icon="🔨"), # combine with victim
  ],
  "Resources": [
